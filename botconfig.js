module.exports = {
  ...
  Token: process.env.Token || "MTE0OTI4NjA4NzQzMzQwMDQyMQ.GcM8nk.uCg_yVqhnfBuF8FOTHmeufw_nncZX8mrxpv_xA", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1149286087433400421", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "I_Fa7CV45TGZaVm1F-T4BVMiPqS5gA-I", // Discord Client Secret
  ...
  Website: process.env.Website || "https://bot.korstuss.me", // Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
  // If you get invalid oauth, make sure on the discord developer page you set the oauth url to something like: https://example.com/api/callback.

  Presence: {
    status: "online", // You can show online, idle, and dnd
    name: "Puppando al bomber", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "2b7feb45ac1045a3a552a56ac9e9d8e9", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "370064a194b14655a455662b2d987fe1", // Spotify Client Secret
  },
};
